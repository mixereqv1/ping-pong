...
export function updateBall(dt) {
    ...
    // COLLISIONS
    if (game_state.ball_x <= (game_state.player_x + game.player_width) && game_state.ball_x >= game_state.player_x && game_state.ball_y >= game_state.player_y && game_state.ball_y <= (game_state.player_y + game.player_height)) {
        game.going_left = false;
    } else if (game_state.ball_x >= game_state.enemy_x && game_state.ball_x <= (game_state.enemy_x + game.enemy_width) && game_state.ball_y >= game_state.enemy_y && game_state.ball_y <= (game_state.enemy_y + game.enemy_height)) {
